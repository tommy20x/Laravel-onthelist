    ...
    <div class="container-fluid">
        ...
        <div class="row mt-4">
            <div class="col-md-12 col-sm-12 col-lg-12 col-xl-8 col-xxl-8">
                <form method="POST" action="{{ route('admin.venues.uploadImage', $venue->id) }}" class="EventForm needs-validation" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="file-field addEventFeature" id="feature_image_wrapper">
                                    <div class="addEvent-icon" id="feature-image-uploader">
                                        ...
                                        <span>Add Venue Feature Image</span>
                                        <span id="feature-image-file-name">{{ $venue->feature_image_path ?? old('feature_image_path') }}</span>
                                    </div>
